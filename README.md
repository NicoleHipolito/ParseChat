...
1. It would probably be the timer of the app
2. Wrapping the view around the text and heirarchy with contraints.
...
The hardest part would probably be the timer one because we weren't experienced with it.
